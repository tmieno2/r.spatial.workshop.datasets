...
prism_saunders <- st_as_stars(prism_saunders)
prism_douglas <- st_as_stars(prism_douglas)
...
county_yield <-
  ...
  .[, .[, .(corn_yield, soy_yield, year, d0_5_9, d1_5_9, d2_5_9, d3_5_9, d4_5_9, geometry)]] %>%
  st_as_sf()
